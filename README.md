This README explains **Big overview of TypeScript with an examples & many more details**
...
Run compiled JavaScript i.e for index.ts to index.js & run it using node.
